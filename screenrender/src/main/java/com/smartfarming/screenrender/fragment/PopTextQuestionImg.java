...
public class PopTextQuestionImg extends BaseDialogFragment implements OnFragmentLoad {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.popup_text_question_img, container, false);
...
//        Utility.trackScreenByScreenName(getActivity(), languageManager.getLabel(title_label));
    ...
    public void setScreenContent() {
        if (screen_id != null) {
            ...
            AppUtility.renderHtmlInATextView(tv_dialog_description, screenModel.getTextModels().get(0).getValue(), this);
            AppUtility.renderHtmlInATextView(tv_dialog_question, screenModel.getTextModels().get(1).getValue(), this);
            ...
            // tvBtn1.setCompoundDrawablesWithIntrinsicBounds(null, FileManager.getImageDrawable(getActivity(),screenModel.getImageModels().get(0).getName()),null,null);
            tvBtn1.setText(screenModel.getImageModels().get(0).getInfo());
